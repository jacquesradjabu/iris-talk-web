export default function ProfileId() {
    return (
        <div className="flex-1 items-center justify-center">
            {/* <!-- Card start --> */}
            <div className="max-w-sm mx-auto border border-gray-300 rounded-lg overflow-hidden mt-4">
                    ...
                    <div className="flex">
                        <div className="flex justify-end mr-2">
                            <img className="border-2 border-white dark:border-gray-800 rounded-full h-10 w-10 -mr-2"
                                src="https://randomuser.me/api/portraits/men/32.jpg" alt="" width={40} height={40} />
                            <img className="border-2 border-white dark:border-gray-800 rounded-full h-10 w-10 -mr-2"
                                src="https://randomuser.me/api/portraits/women/31.jpg" alt="" width={40} height={40} />
                            <img className="border-2 border-white dark:border-gray-800 rounded-full h-10 w-10 -mr-2"
                                src="https://randomuser.me/api/portraits/men/33.jpg" alt="" width={40} height={40} />
                            <img className="border-2 border-white dark:border-gray-800 rounded-full h-10 w-10 -mr-2"
                                src="https://randomuser.me/api/portraits/women/32.jpg" alt="" width={40} height={40} />
                            <img className="border-2 border-white dark:border-gray-800 rounded-full h-10 w-10 -mr-2"
                                src="https://randomuser.me/api/portraits/men/44.jpg" alt="" width={40} height={40} />
                            <img className="border-2 border-white dark:border-gray-800 rounded-full h-10 w-10 -mr-2"
                                src="https://randomuser.me/api/portraits/women/42.jpg" alt="" width={40} height={40} />
                            <span
